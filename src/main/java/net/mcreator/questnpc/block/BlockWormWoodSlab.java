...
public class BlockWormWoodSlab extends ElementsQuestNpcMod.ModElement {
	@GameRegistry.ObjectHolder("quest_npc:worm_wood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("quest_npc:worm_wood_slab_double")
	public static final Block block_slab_double = null;
	public BlockWormWoodSlab(ElementsQuestNpcMod instance) {
		super(instance, 26);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("worm_wood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("worm_wood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("quest_npc:worm_wood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("worm_wood_slab");
