...
public class BlockWortweed extends ElementsQuestNpcMod.ModElement {
	@GameRegistry.ObjectHolder("quest_npc:wortweed")
	public static final Block block = null;
	public BlockWortweed(ElementsQuestNpcMod instance) {
		super(instance, 2);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("quest_npc:wortweed", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("wortweed");
			setRegistryName("wortweed");
		}
