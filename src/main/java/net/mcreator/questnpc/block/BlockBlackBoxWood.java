...
public class BlockBlackBoxWood extends ElementsQuestNpcMod.ModElement {
	@GameRegistry.ObjectHolder("quest_npc:black_box_wood")
	public static final Block block = null;
	public BlockBlackBoxWood(ElementsQuestNpcMod instance) {
		super(instance, 43);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("quest_npc:black_box_wood", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("black_box_wood");
			setRegistryName("black_box_wood");
		}
