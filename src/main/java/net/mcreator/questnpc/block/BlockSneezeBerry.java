...
public class BlockSneezeBerry extends ElementsQuestNpcMod.ModElement {
	@GameRegistry.ObjectHolder("quest_npc:sneeze_berry")
	public static final Block block = null;
	public BlockSneezeBerry(ElementsQuestNpcMod instance) {
		super(instance, 9);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("quest_npc:sneeze_berry", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("sneeze_berry");
			setRegistryName("sneeze_berry");
		}
