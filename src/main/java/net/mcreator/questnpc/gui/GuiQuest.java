...
package net.mcreator.questnpc.gui;
...
import net.mcreator.questnpc.QuestNpcMod;
...
public class GuiQuest extends ElementsQuestNpcMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiQuest(ElementsQuestNpcMod instance) {
		super(instance, 1);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				QuestNpcMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void actionPerformed(GuiButton button) {
			QuestNpcMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
